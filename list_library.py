...
greetings = ["Hello, thanks for visiting", "Good to see you again", "Hi there, how can I help?", "Hey human!",
             "Good day Sir", "Hola human!"]

goodbyes = ["See you later, thanks for visiting", "Have a nice day", "Bye! Come back again soon.",
